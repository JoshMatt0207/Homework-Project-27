...
var playerArrows = [];
var board1, board2;
var board2Collision, board1Collision
...
function draw() {
  ...
  for (var i = 0; i < playerArrows.length; i++) {
    if (playerArrows[i] !== undefined) {
      ...
      board1Collision=Matter.SAT.collides(board1.body, playerArrows[i].body)
      board2Collision=Matter.SAT.collides(board2.body, playerArrows[i].body)
